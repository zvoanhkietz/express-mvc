$(document).ready(function(){
	...
	if($('#news-feed')[0]){
	    $('#news-feed').FeedEk({
		FeedUrl: 'http://vnexpress.net/rss/tin-moi-nhat.rss',
		MaxCount: 5,
		ShowDesc: false,
		ShowPubDate: true,
